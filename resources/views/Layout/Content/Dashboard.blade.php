...
<section class="content">
    <div class="container-fluid">
        ...
        <!-- Additional Info Boxes for Department and Students -->
        <div class="row">
            <div class="col-12 col-sm-6 col-md-3">
                <div class="info-box mb-3">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number">{{ $departementCount }}</span>
                    </div>
                </div>
            </div>
            <div class="col-12 col-sm-6 col-md-3">
              ...
              <div class="card-body">
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <div class="chart">
                            <canvas id="salesChart" height="10" style="height: 180px;"></canvas>
                        </div>
                    </div>
                  ...
                  <div class="col-md-4">
                    ...
                    <div class="progress-group">
                        ...
                        <div class="progress progress-sm">
                            <div class="progress-bar bg-{{ ['primary', 'danger', 'success', 'warning'][$loop->index % 4] }}" style="width: 100%"></div>
                        </div>
                    </div>
                @endforeach
            </div>
